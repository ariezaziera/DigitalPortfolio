            ...
            <div className="mt-6 relative border-l-4 border-purple-500 pl-6 space-y-6">
              {experiences.map((exp, index) => (
                <motion.div
                  ...
                  className="relative p-6 rounded-2xl border border-white/20 bg-white/20
                  backdrop-blur-sm shadow-[0_0_30px_rgba(255,255,255,0.1)] transition-all duration-300
